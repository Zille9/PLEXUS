...
PUB main | i
  ...
  'Start "Propeller Signal Generator" and output signal on pin 8 (inverted signal on pin 9)
  psg.start(8, 9, 32) ' Sync pin = 32 = No pin
  ...
  repeat
   ...
   'Generate a 100 Hz sinus wave for 2 seconds
    psg.setParameters(psg#SINE, 500, 0, 0)
    waitcnt(cnt + 80_000_000 * 2)
   ...
   'Generate a 1 kHz sample and hold noise wave for 2 seconds           
    psg.setParameters(psg#NOISE, 2000, 0, 0)
    waitcnt(cnt + 80_000_000 * 2)
   ...
   'Generate a 80 Hz triangle wave for 2 seconds      
    psg.setParameters(psg#TRIANGLE, 380, 0, 0)
    waitcnt(cnt + 80_000_000 * 2)
