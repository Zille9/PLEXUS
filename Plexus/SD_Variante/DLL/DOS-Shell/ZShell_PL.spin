...
24-11-2013      :-Erstellung der Optik des Fensters
...
PRI Display_Info
    ...
    Print_win(string("ZSHELL for Hive"),9,10)
    Print_win(string("Version 1.0 - 02/2021"),9,11)
...
pri testfenster|i,y,a
    ...
    a:=0
    window(0,4,2,1,27,38,string("Plexus-ZSHELL"))
    rahmen (1,6,38,27)
    rahmen (1,1,38,3)
    rahmen (1,4,38,6)
    ...
    Print_win(string("DOS-Shell for Hive-Computer V1.2"),2,2)
